// wap to enter two matirx and print subtraction of two matrices stored in third matrix
#include<iostream> 
using namespace std;
...
cout<<"enter 16 numbers from your matrices:"<<endl;
for (int x = 0; x < 4 ; x++)   // Outer for loop for traversing rows
   ...
   cout << "subtracion of two matrix is  : \n" ;
   for (int x = 0; x < 4 ; x++)   // Outer for loop for traversing rows
   {
      for(int y = 0; y < 2 ; y++)   // Inner for loop for traversing columns
      {
